 ...
 */
public class RegistrarWindowUserList extends javax.swing.JFrame {

    /**
     * Creates new form AdminWindowUserList
     */
    public RegistrarWindowUserList() {
        initComponents();
        SetTableView();
        AddColumnListener();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegistrarWindowUserList.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RegistrarWindowUserList().setVisible(true);
            }
        });
    }

 ...
 */
public class TeacherWindowSubjects extends javax.swing.JFrame {

    /**
     * Creates new form AdminWindowSubjects
     */
    public TeacherWindowSubjects() {
        initComponents();
        SetTableView();
        AddColumnListener();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TeacherWindowSubjects.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TeacherWindowSubjects().setVisible(true);
            }
        });
    }
